...
static cystatus Serial_Programmer_WriteFlashByte(const uint32 address, const uint8 inputValue) CYLARGE \
                               ;
#endif /*(CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER)*/

/*******************************************************************************
* Function Name: Serial_Programmer_Load
****************************************************************************//**
*
* \brief
...
*
*******************************************************************************/
void Serial_Programmer_Load(void) 
{
    /* Schedule Bootloader to start after reset */
    Serial_Programmer_SET_RUN_TYPE(Serial_Programmer_SCHEDULE_BTLDR);
...
#if (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER)
/*******************************************************************************
* Function Name: Serial_Programmer_GetActiveApplication
****************************************************************************//**
*
* \brief
...
{   
    uint8 result = Serial_Programmer_MD_BTLDB_ACTIVE_NONE;
    
    if (0u != Serial_Programmer_GET_CODE_DATA( \
              Serial_Programmer_MD_BTLDB_ACTIVE_OFFSET(Serial_Programmer_MD_BTLDB_ACTIVE_0))) 
    {
        result = Serial_Programmer_MD_BTLDB_ACTIVE_0;
    }
    else if (0u != Serial_Programmer_GET_CODE_DATA( \
                   Serial_Programmer_MD_BTLDB_ACTIVE_OFFSET(Serial_Programmer_MD_BTLDB_ACTIVE_1)))
    {
        result = Serial_Programmer_MD_BTLDB_ACTIVE_1;    
    }
    else
    {
...
/*******************************************************************************
* Function Name: Serial_Programmer_SetActiveApplication
****************************************************************************//**
*
* \brief 
                ...
                
{
    ...
    if (appId > Serial_Programmer_MD_BTLDB_ACTIVE_1)
    {
    ...
    else
    {
        ...
        if (1u == Serial_Programmer_GET_CODE_DATA(Serial_Programmer_MD_BTLDB_ACTIVE_OFFSET(appId)))
        {
            result = CYRET_BAD_PARAM;
        }
        else
        {
            ...
            for(idx = 0u; idx < Serial_Programmer_MAX_NUM_OF_BTLDB; idx++)
            {
                result |= Serial_Programmer_WriteFlashByte((uint32) Serial_Programmer_MD_BTLDB_ACTIVE_OFFSET(idx), \
                                                                                            (uint8)(idx == appId));
            }
        }
    }
...
/*******************************************************************************
* Function Name: Serial_Programmer_WriteFlashByte
****************************************************************************//**
*
* \brief 
                               ...
                               
{
    ...
    {
        rowData[idx] = (uint8)Serial_Programmer_GET_CODE_DATA(baseAddr + idx);
    }
...
void Serial_Programmer_SetFlashByte(uint32 address, uint8 runType) 
{
    ...
    for (idx = 0u; idx < CYDEV_FLS_ROW_SIZE; idx++)
    {
        rowData[idx] = Serial_Programmer_GET_CODE_DATA(baseAddr + idx);
    }
