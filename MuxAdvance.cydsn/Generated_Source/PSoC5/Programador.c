...
/*******************************************************************************
* Function Name: Programador_Load
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Programador_Load(void) 
{
    /* Schedule Bootloader to start after reset */
    Programador_SET_RUN_TYPE(Programador_START_BTLDR);
...
void Programador_SetFlashByte(uint32 address, uint8 runType) 
{
    ...
    {
        rowData[idx] = Programador_GET_CODE_DATA(baseAddr + idx);
    }
