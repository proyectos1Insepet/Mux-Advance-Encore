...
static cystatus Programmer_WriteFlashByte(const uint32 address, const uint8 inputValue) CYLARGE \
                               ;
#endif /*(CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER)*/

/*******************************************************************************
* Function Name: Programmer_Load
****************************************************************************//**
*
* \brief
...
*
*******************************************************************************/
void Programmer_Load(void) 
{
    /* Schedule Bootloader to start after reset */
    Programmer_SET_RUN_TYPE(Programmer_SCHEDULE_BTLDR);
...
#if (CYDEV_PROJ_TYPE == CYDEV_PROJ_TYPE_LOADABLEANDBOOTLOADER)
/*******************************************************************************
* Function Name: Programmer_GetActiveApplication
****************************************************************************//**
*
* \brief
...
{   
    uint8 result = Programmer_MD_BTLDB_ACTIVE_NONE;
    
    if (0u != Programmer_GET_CODE_DATA( \
              Programmer_MD_BTLDB_ACTIVE_OFFSET(Programmer_MD_BTLDB_ACTIVE_0))) 
    {
        result = Programmer_MD_BTLDB_ACTIVE_0;
    }
    else if (0u != Programmer_GET_CODE_DATA( \
                   Programmer_MD_BTLDB_ACTIVE_OFFSET(Programmer_MD_BTLDB_ACTIVE_1)))
    {
        result = Programmer_MD_BTLDB_ACTIVE_1;    
    }
    else
    {
...
/*******************************************************************************
* Function Name: Programmer_SetActiveApplication
****************************************************************************//**
*
* \brief 
                ...
                
{
    ...
    if (appId > Programmer_MD_BTLDB_ACTIVE_1)
    {
    ...
    else
    {
        ...
        if (1u == Programmer_GET_CODE_DATA(Programmer_MD_BTLDB_ACTIVE_OFFSET(appId)))
        {
            result = CYRET_BAD_PARAM;
        }
        else
        {
            ...
            for(idx = 0u; idx < Programmer_MAX_NUM_OF_BTLDB; idx++)
            {
                result |= Programmer_WriteFlashByte((uint32) Programmer_MD_BTLDB_ACTIVE_OFFSET(idx), \
                                                                                            (uint8)(idx == appId));
            }
        }
    }
...
/*******************************************************************************
* Function Name: Programmer_WriteFlashByte
****************************************************************************//**
*
* \brief 
                               ...
                               
{
    ...
    {
        rowData[idx] = (uint8)Programmer_GET_CODE_DATA(baseAddr + idx);
    }
...
void Programmer_SetFlashByte(uint32 address, uint8 runType) 
{
    ...
    for (idx = 0u; idx < CYDEV_FLS_ROW_SIZE; idx++)
    {
        rowData[idx] = Programmer_GET_CODE_DATA(baseAddr + idx);
    }
