...
#define LCD1_TXBUFFERSIZE                   (4u)
#define LCD1_RXBUFFERSIZE                   (8u)
...
#define LCD1_BIT_CENTER                         (LCD1_OVER_SAMPLE_COUNT - 1u)
...
extern uint8 LCD1_initVar;
    ...
    extern volatile uint8 LCD1_txBuffer[LCD1_TXBUFFERSIZE];
    extern volatile uint8 LCD1_txBufferRead;
    extern uint8 LCD1_txBufferWrite;
#endif /* End LCD1_TX_ENABLED */
#if( ( LCD1_RX_ENABLED || LCD1_HD_ENABLED ) && \
     (LCD1_RXBUFFERSIZE > LCD1_FIFO_LENGTH) )
    extern volatile uint8 LCD1_rxBuffer[LCD1_RXBUFFERSIZE];
...
#if (LCD1_RXHW_ADDRESS_ENABLED)
    #define LCD1_RXADDRESSMODE      (0u)
    #define LCD1_RXHWADDRESS1       (0u)
    #define LCD1_RXHWADDRESS2       (0u)
